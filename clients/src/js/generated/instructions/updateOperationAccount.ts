...
export const UPDATE_OPERATION_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  127, 70, 119, 40, 188, 227, 61, 7,
]);

export function getUpdateOperationAccountDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    UPDATE_OPERATION_ACCOUNT_DISCRIMINATOR
  );
}

export type UpdateOperationAccountInstruction<
...
export function getUpdateOperationAccountInstructionDataEncoder(): Encoder<UpdateOperationAccountInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['param', getU8Encoder()],
      ['keys', getArrayEncoder(getAddressEncoder())],
    ]),
    (value) => ({
      ...value,
...
export function getUpdateOperationAccountInstructionDataDecoder(): Decoder<UpdateOperationAccountInstructionData> {
  return getStructDecoder([
    ...
    ['param', getU8Decoder()],
    ['keys', getArrayDecoder(getAddressDecoder())],
  ]);
}

export function getUpdateOperationAccountInstructionDataCodec(): Codec<
  UpdateOperationAccountInstructionDataArgs,
  UpdateOperationAccountInstructionData
> {
  return combineCodec(
...
export type UpdateOperationAccountInput<
...
>(
  input: UpdateOperationAccountInput<
    TAccountOwner,
    TAccountOperationState,
    TAccountSystemProgram
  >,
...
> {
  ...
  return Object.freeze({
    ...
    data: getUpdateOperationAccountInstructionDataEncoder().encode(
      args as UpdateOperationAccountInstructionDataArgs
    ),
    programAddress,
  } as UpdateOperationAccountInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountOperationState,
    TAccountSystemProgram
...
export type ParsedUpdateOperationAccountInstruction<
  TProgram extends string = typeof AMM_V3_PROGRAM_ADDRESS,
...
export function parseUpdateOperationAccountInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedUpdateOperationAccountInstruction<TProgram, TAccountMetas> {
