...
export function getObservationStateEncoder(): FixedSizeEncoder<ObservationStateArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      [
        'observations',
        getArrayEncoder(getObservationEncoder(), { size: 1000 }),
      ],
      ['padding', getArrayEncoder(getU128Encoder(), { size: 5 })],
    ]),
...
export function getObservationStateDecoder(): FixedSizeDecoder<ObservationState> {
  return getStructDecoder([
    ...
    ['observations', getArrayDecoder(getObservationDecoder(), { size: 1000 })],
    ['padding', getArrayDecoder(getU128Decoder(), { size: 5 })],
  ]);
}
